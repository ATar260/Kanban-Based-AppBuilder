...
export function GitHubConnectButton({
        ...
        return (
            <div className={`flex items-center gap-2 ${className}`}>
                <div className="flex items-center gap-2 px-3 py-1.5 bg-green-500/10 border border-green-500/20 rounded-lg">
                    ...
                    <span className="text-sm text-green-400">@{connection.username}</span>
    ...
    return (
        <button
            ...
            className={`flex items-center gap-2 px-4 py-2 bg-gray-800 hover:bg-gray-700 border border-gray-600 rounded-lg transition-colors ${className}`}
        >
            <svg
                className="w-5 h-5"
                fill="currentColor"
